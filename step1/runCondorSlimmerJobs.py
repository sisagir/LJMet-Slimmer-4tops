...
#inputDir='/eos/uscms/store/user/npervan/FWLJMET102X_1lep2016_Jan2021/'
inputDir='/isilon/hadoop/store/group/bruxljm/FWLJMET102X_1lep'+str(Year)+'_Jan2021/' # or 2018
outputDir='/eos/uscms/store/user/npervan/FWLJMET102X_1lep'+str(Year)+'_Jan2021_4t_021821_step1/nominal/' # or 2018
condorDir='/uscms_data/d3/npervan/TTTT/CMSSW_10_2_16_UL/src/LJMet-Slimmer-4tops/step1/FWLJMET102X_1lep'+str(Year)+'_Jan2021_4t_021821_step1/' # or 2018
...
=======
   # if 'TuneCP5down' in sample or 'TuneCP5up' in sample or 'hdampDOWN' in sample or 'hdampUP' in sample: outList = ['none']
>>>>>>> f4ec4847459831085ca19afac5dafe08ad6be353

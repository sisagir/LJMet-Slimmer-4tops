...
shift = sys.argv[1]
Year = 2018
inputDir='/eos/uscms/store/user/ssagir/FWLJMET102X_1lep'+str(Year)+'_Oct2019_4t_redJECs_120420_step1/'+shift+'/'
outputDir='/eos/uscms/store/user/ssagir/FWLJMET102X_1lep'+str(Year)+'_Oct2019_4t_redJECs_120420_step1hadds/'+shift+'/'
condorDir='/uscms_data/d3/ssagir/FWLJMET102X_1lep'+str(Year)+'_Oct2019_4t_redJECs_120420_step1hadds/'+shift+'/'
inDir=inputDir[10:]
outDir=outputDir[10:]
runDir=os.getcwd()
